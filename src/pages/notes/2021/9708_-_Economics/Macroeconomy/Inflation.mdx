...
- Deflation is associated with a recession and it is very difficult to use macroeconomal tools to correct.

2) Inflation is more difficult to deal with if it is unstanble and prologed

3_ Unanticipated inflation causes a shock to the economiy and is much more difficult to manage

4) Inflation as compared to trading parnets is important as inflaction can affect international compoetititveness

5) Managing inflationary expectations is very important in controlling inflation. NZ does this by havig an independant central bank and credible monetary policy.