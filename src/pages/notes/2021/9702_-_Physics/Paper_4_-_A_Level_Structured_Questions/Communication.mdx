...
<Typography>
    ...
    When received, the signal can be regenerated into its analog form using a DAC (Digital to analog converter)
</Typography>
...
<TableRow>
    <TableCell>Lower latency (as closer to Earth), however, you will need to calculate or track its position to communicate with it</TableCell>
